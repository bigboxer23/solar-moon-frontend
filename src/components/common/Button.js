...
const secondaryButtonClass =
  'bg-neutral-200 text-sm text-black dark:text-white rounded-full font-bold py-2 px-5 tracking-wide leading-4 transition-all hover:brightness-105';
...
const outlineSecondaryButtonClass =
  'bg-white dark:bg-neutral-700 text-sm text-black dark:text-white rounded-full font-bold py-2 px-5 tracking-wide leading-4 border border-neutral-300 transition-all hover:border-neutral-500';
...
const outlineDangerButtonClass =
  'bg-white dark:bg-neutral-700 text-sm text-black dark:text-white rounded-full font-bold py-2 px-5 tracking-wide leading-4 border border-red-700 text-red-700 transition-all hover:brightness-110';
const textButtonClass = 'font-bold tracking-wide text-sm underline';
const iconButtonClass =
  'text-neutral-600 transition-all hover:text-black dark:text-white';
