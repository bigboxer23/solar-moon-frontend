...
describe('HeaderBar', () => {
  describe('Basic Rendering', () => {
    ...
    test('renders without leftContent when not provided', () => {
      ...
      const leftContentContainer = document.querySelector('.flex.items-center.justify-center');
  ...
  describe('Props Handling', () => {
    ...
    test('handles long header text', () => {
      const longHeaderText = 'This is a very long header text that might wrap or overflow depending on screen size';
  ...
  describe('Component Structure', () => {
    ...
    test('applies correct classes to left content container', () => {
      ...
      const leftContainer = document.querySelector('.flex.items-center.justify-center');
      expect(leftContainer).toHaveClass('flex', 'items-center', 'justify-center');
    });
  ...
  describe('Layout Structure', () => {
    test('maintains proper layout structure with left content and header text', () => {
      ...
      const leftSection = mainContainer.querySelector('.flex.items-center.justify-center');
      ...
      const headerSection = mainContainer.querySelector('.ms-4.flex.items-center');
  ...
  describe('Integration', () => {
    test('works with different types of left content', () => {
      const testCases = [
        ...
        { content: <div data-testid="div-content">Div Content</div>, testId: 'div-content', text: 'Div Content' },
        { content: <span>Span Content</span>, testId: null, text: 'Span Content' },
        { content: <a href="#" data-testid="link">Link</a>, testId: 'link', text: 'Link' },
      ];

      testCases.forEach(({ content, testId, text }) => {
        const { unmount } = render(<HeaderBar headerText="Test" leftContent={content} />);
